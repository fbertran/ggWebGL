...
```{r density2d-contours, eval = FALSE}
...
```{r gridded-contour-lines, eval = FALSE}
...
```{r label-overlay-metadata, eval = FALSE}
...
```{r fixed-scale-facets, eval = FALSE}

...
feature. These labels reflect API maturity, test coverage, and
...
| Text annotations | [`geom_text_webgl()`](https://fbertran.github.io/ggWebGL/reference/geom_text_webgl.md), [`geom_label_webgl()`](https://fbertran.github.io/ggWebGL/reference/geom_label_webgl.md) | Metadata-only | Text and label layers are overlay metadata, not WebGL glyph rendering. |
| Rug annotations | [`geom_rug_webgl()`](https://fbertran.github.io/ggWebGL/reference/geom_rug_webgl.md) | Stable | Rugs use segment primitives. |

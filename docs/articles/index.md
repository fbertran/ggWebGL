...
- [ggplot-like geom coverage in
  ggWebGL](https://fbertran.github.io/ggWebGL/articles/ggplot-coverage.md):
...
- [Real-Data
  Evidence](https://fbertran.github.io/ggWebGL/articles/real-data-evidence.md):

### Optional downstream bridges

- [Optional XGeoRTR
  Bridge](https://fbertran.github.io/ggWebGL/articles/xgeortr-bridge.md):
- [Swarm Art in the Browser with
  boids4R](https://fbertran.github.io/ggWebGL/articles/boids4r-animation.md):

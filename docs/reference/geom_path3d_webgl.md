...
Add an ordered three-dimensional path layer that is tagged for the
`ggWebGL` rendering pipeline. Unlike
[`geom_line_webgl()`](https://fbertran.github.io/ggWebGL/reference/geom_line_webgl.md),
this geom is based on
[`ggplot2::GeomPath`](https://ggplot2.tidyverse.org/reference/Geom.html)
and preserves row order within each group.

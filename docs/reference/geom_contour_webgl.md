...
[`ggplot2::StatContour`](https://ggplot2.tidyverse.org/reference/Stat.html);
this layer serializes the built contour paths as grouped WebGL line
primitives. Filled contours are not rendered by this layer.

...
Add label annotations tagged for the `ggWebGL` renderer. Labels are
serialized as text overlay metadata with background-box styling
metadata; they are not drawn as WebGL glyphs.

...
Add a crossbar layer tagged for the `ggWebGL` renderer. Crossbars
serialize to one filled rectangle payload for the body and one pure
segment payload for the middle line.
